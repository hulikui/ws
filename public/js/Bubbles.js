...
+function()
{
  ...
  function SPEED_X(){return 3 + RND() * 4}
  function SPEED_Y(){return 2 + RND() * 2}
  ...
  CreateBubble = function(tag)
  {
    var bub = new Bubble(tag);
  ...
  function Bubble(tag)
  {
    ...
    for(var i=0; i<4; i++)
    {
      ...
      {
        if(_IE6_)
          sty.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src=/image/heart.png)";
        else
          sty.backgroundImage = "url(/image/heart.png)";
